### experiments/adb:20160211
Built: Thu Mar 10 10:39:39 CET 2016
...
dev-libs/libusb-1.0.19-r1 | `-debug -doc -examples -static-libs {-test} -udev`
dev-util/android-tools-5.1.1_p13 | ``
sys-apps/hwids-20150717-r1 | `net pci udev usb`
sys-apps/kmod-21 | `tools zlib -debug -doc -lzma -python -static-libs`
sys-apps/usbutils-008-r1 | `-python`
...
sys-fs/udev-225 | `acl kmod (-selinux) -static-libs`
