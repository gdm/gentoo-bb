...
#cd /home/dmgo/dev/tools/ideaIC/idea-IC-135.1230
#cd /home/dmgo/dev/tools/ideaIC/idea-IC-139.225.3
#cd /home/dmgo/dev/tools/ideaIC/idea-IU-139.659.2
#cd /home/dmgo/dev/tools/ideaIC/idea-IC-139.1117.1
# can be IU or IC
cd /home/dmgo/dev/tools/ideaIC/idea-${1:-IU}-139.1117.1
exec ./bin/idea.sh
